...
import {
	eachPostCommentTypes,
	eachUserPostTypes,
	PostLikeRequestObjTypes,
} from "../../Types/UserPostsTypes";
...
class UserPostModel implements eachUserPostTypes {
	...
	@action.bound getPostLikeResponse = (
	...
	fetchPostLikeStatus = (
		requestObj: PostLikeRequestObjTypes,
	): Promise<Object> => {
		const postsResponse =
			postLikeStatusServiceInstance.getPostLikeStatus(requestObj);
