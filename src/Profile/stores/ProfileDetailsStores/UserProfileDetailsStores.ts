...
class UserProfileDetailsStores {
	...
	constructor(UserProfileDetailsServiceApi) {
		this.userProfileDetailsApiService =
			UserProfileDetailsServiceApi;
		this.userProfileDetailsStatus = API_INITIAL;
		this.userProfileDetailsResponse =
			{} as UserProfileDetailsAndResponseStatusTypes;
	}
	...
	@action.bound getUserProfileDetailsStatus = (
	...
	fetchUserProfileDetails = (userId) => {
		const profileDetails =
			this.userProfileDetailsApiService.getUserProfileDetails(userId);
